    ...
    <x-content.main-content-page>
        <div class="row ">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><span class="text-bold">Nom: </span>{{$outpatientBill->client_name}}</h5><br>
                        <h5 class="card-title"><span class="text-bold">Type: </span> Privé</h5><br>
                        <h5 class="card-title"><span class="text-bold">Date: </span> {{ $outpatientBill->created_at->format('d/m/Y H:i:s') }}</h5>
                    </div>
                </div>
            ...
            <div class="col-md-6">
              @livewire('application.labo.screens.list-items-outpatient-labo',['outpatientBill'=>$outpatientBill])
            </div>
        </div>
    </x-content.main-content-page>
</div>
