    ...
    <div class="card card-success">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    @if ($categroryTarif->getOutpatientBillTarifItems($outpatientBill, $categroryTarif)->isEmpty())
                          <tr>
                                <td colspan="4" class="text-center"> <x-errors.data-empty /></td>
                            </tr>
                    @else
                         @foreach ($categroryTarif->getOutpatientBillTarifItems($outpatientBill, $categroryTarif) as $tarif)
                        <tr>
