<x-print-layout>
    @foreach ($sources as $source)
        @php
            ...
            $consultationRequests = App\Repositories\Product\Get\GetConsultationRequestGroupingCounterRepository::
            getConsultationRequestGroupingBySubscriptionHospitalizeBySource(
                $month,
                $year,
                $source->id,
            );
