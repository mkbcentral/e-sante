...
use App\Imports\ConsultationSheetAgentImport;
use Exception;
...
class ImportAgentSheetView extends Component
{
    use WithFileUploads;
    ...
    public function importPrivateSheets()
    {
        $this->validate();
        try {
            Excel::import(new ConsultationSheetAgentImport, $this->file);
    ...
    {
        return view('livewire.application.files.screens.import-agent-sheet-view');
    }
}
