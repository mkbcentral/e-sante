...
class DoctorConsultPatient extends Component
{
    use WithPagination;
    protected $listeners = [
        'selectedIndex' => 'getSelectedIndex',
        'refreshConsulting' => '$refresh',
        'consultationRequestPara'=>'getConsultationRequest',
    ];
    ...
    {
        return view('livewire.application.sheet.form.doctor-consult-patient', [
